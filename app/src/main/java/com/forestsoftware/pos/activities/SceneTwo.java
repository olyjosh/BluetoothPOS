...
public class SceneTwo extends AppCompatActivity implements ItemClickListener, View.OnClickListener {
            ...
            case R.id.Send_Button: {
                if (hexBox.isChecked()) {
                    ...
                    if (str.length() > 0) {
                        ...
                        Toast.makeText(SceneTwo.this, getText(R.string.empty), Toast.LENGTH_SHORT).show();
                    }
                } else {
...
/****************************************************************************************************/
    ...
    private void printBarCode() {
        ...
        new AlertDialog.Builder(SceneTwo.this).setTitle(getText(R.string.btn_prtcode))
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (which == 0) {
                            if (str.length() == 11 || str.length() == 12) {
                                ...
                                Toast.makeText(SceneTwo.this, getText(R.string.msg_error), Toast.LENGTH_SHORT).show();
                                return;
                            }
                        } else if (which == 1) {
